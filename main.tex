...
\begin{abstract}
Smart sprinkler irrigation control and interface designed with Python and I2C using raspberry pi's,sensors, relay board, ESP32 chip and a mobile/desktop interface that allows a user to schedule watering with real time feedback for adjustments.
\end{abstract}
