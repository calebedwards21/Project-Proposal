...
\subsection{Spring}
\begin{itemize}
    \item Finish initial design/research.
    \item Finish and submit project proposal.
    \item Start interface development.
\end{itemize}

\subsection{Summer}
\begin{itemize}
    \item Connect sensors to Pi for testing
    \item Collect data using chosen sensors
    \item ESP testing
\end{itemize}

\subsection{August}
\begin{itemize}
    \item Interface finished and testing
    \item Get relay working with Pi to activate valves
    \item Create algorithms per sensor
\end{itemize}

\subsection{September}
\begin{itemize}
    \item Finalize sensors to use
    \item Finalize Database layout
    \item Build sensor arrays
    \item Integrate all parts with wired communications
    \item Start developing wireless communication
\end{itemize}

\subsection{October}
\begin{itemize}
    \item Combine algorithms together
    \item Build sprinkler demo
    \item Want wireless to be finished
\end{itemize}

\subsection{November}
\begin{itemize}
    \item Wireless fully integrated
    \item Demo tested
