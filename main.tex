...
\resizebox{0.45\textwidth}{!}{%
    \begin{tabular}{}
      ...
      \href{https://www.raspberrypi.org/products/raspberry-pi-3-model-b-plus/}{Raspberry Pi} & \href{https://www.adafruit.com/product/3055#technical-details}{Adafruit} & Raspberry Pi 3 B+ \\
        ...
        \hline
        \href{https://www.sainsmart.com/products/8-channel-5v-relay-module}{Sain Smart} & \href{https://wiki.52pi.com/index.php/DockerPi_4_Channel_Relay_SKU:_EP-0099}{52Pi} & \href{https://www.sainsmart.com/products/8-channel-5v-relay-module}{Relay Board}  \\
        \hline
        \end{tabular}
   \end{tabular}%
   }
