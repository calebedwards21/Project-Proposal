...
\begin{abstract}
Smart sprinkler irrigation control and interface designed with Python and I2C using Raspberry Pi's, sensors, relay board, ESP32 microcontroller and a mobile/desktop interface that allows a user to schedule watering with real time feedback for adjustments.
\end{abstract}
